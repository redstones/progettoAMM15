...
include_once 'CompetizioneFactory.php';
...
class CategoriaFactory {
	...
	* @return \Categoria */
    ...
    /*Restituisce la lista delle categorie di trofei
	...
	* @return \Categoria*/
    private function getCategoria($row) {
        ...
        $categoria->setCompetizione(CompetizioneFactory::instance()->getCompetizionePerId($row['idcompetizione']));
        return $categoria;
    }
}
?>
